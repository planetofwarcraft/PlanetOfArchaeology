...
Интерфейс поддерживает языки WoW и украинский. Украинский перевод описаний артефактов пока не завершён: для отсутствующих переводов используется язык клиента. Официальные всплывающие подсказки Blizzard остаются на языке игры.
